...
import { Wrapper } from '../../utils/renderWithProviderAndRouter';
...
jest.mock('../../../components/shared/api/getCharactersApiSlice', () => ({
  ...jest.requireActual('../../../components/shared/api/getCharactersApiSlice'),
